$(document).ready(function () {
    ...
    $("#lkCancel").addClass("selectedOptionOrders");

    getCancelOrders();

    $('#gridCancelOrders').on('click', '.btn-link', function (e) {
        e.preventDefault();
...
function getCancelOrders() {
    $.ajax({
        ...
        url: "CancelOrders.aspx/getAllCancelOrders",
        dataType: "json",
...
function getInfoProducts(orderId) {
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: "CancelOrders.aspx/getAllProducts",
        dataType: "json",
